...
export const products: Product[] = [
  ...
  /* ========================= RATONES (ejemplos, agrega los tuyos) ========================= */
  {
    category: "ratones",
    size: "mouse",
    slug: "furycube-g13pro-paw3311",
    name: "Mouse gamer inalámbrico FURYCUBE G13 Pro PAW3311 RGB",
    brand: "Furycube",
    subtitle: "Wireless 2.4GHz + BT + cable, sensor PAW3311, RGB, recargable",
    status: "in_stock",
    priceRub: 37905,
    monthlyRub: 6318,
    model: "G13PRO",
    ...
    colors: ["Negro", "Blanco"],
    description:
      "Mouse gamer inalámbrico con conectividad 2.4GHz + Bluetooth + cable, sensor PAW3311, RGB y batería recargable. Ideal para gaming competitivo y uso diario.",
    sensor: "PAW3311",
    dpiMax: 12000,
    buttons: 6,
    ...
    weight: "150 g",
   images: [  
    { id: "g13pro-2", label: "G13 Pro", url: "/images/mouse/g11/g11.png" },
{ id: "g13pro-2", label: "G13 Pro", url: "/images/mouse/g11/g11.png" },
    { id: "g13pro-2", label: "G13 Pro", url: "/images/mouse/g11/g11.png" },
  ...
  { id: "g11-back-5", label: "Back 5", url: "/images/mouse/g11/back-g11-4.webp" },
    ...
    tags: ["mouse-gamer-inalambrico", "paw3311", "rgb", "recargable", "6-botones"],
  },
]
